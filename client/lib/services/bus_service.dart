...
class BusService {
  ...
  // Search bus by route
  static Future<Map<String, dynamic>> searchBusByRoute(String startLocation, String endLocation) async {
    try {
      final response = await http.get(
        Uri.parse('$baseUrl/bus/search-by-route?startLocation=$startLocation&endLocation=$endLocation'),
        headers: {
          'Content-Type': 'application/json',
        },
      );
